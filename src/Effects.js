...
import getSceneIndicesForInterpolationInputRange from 'react-navigation-stack/dist/utils/getSceneIndicesForInterpolationInputRange';
...
function forVertical(props) {
  ...
  const translateY = position.interpolate({
    inputRange: [height, 0, 0],
    outputRange: [first, index, last],
    extrapolate: 'clamp'
  });
...
function forVerticalUpToBottom(props) {
  const { layout, position, scene } = props;
